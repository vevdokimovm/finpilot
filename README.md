...
[![CI](https://github.com/vevdokimovm/finpilot/actions/workflows/ci.yml/badge.svg)](https://github.com/vevdokimovm/finpilot/actions/workflows/ci.yml)
![version](https://img.shields.io/badge/version-8.19.2-blue)
...
`docs/внутренний журнал.md` (состояние и передача работы).
...
получает не пересказ, а дерево. Отсюда же вахтенный журнал `docs/внутренний журнал.md` как контракт
...
следующие шаги. План — `docs/frontend_milestone8_plan.md`, статус — `docs/внутренний журнал.md`.
...
> [`docs/внутренний журнал.md`](docs/внутренний журнал.md).
...
[PolyForm Noncommercial 1.0.0](LICENSE) © 2025 FINPILOT
